...
pdf('d:/dropbox/working/stan_bayesian_modeling/greg/plots/ind_regressions.pdf')
...
pdf('d:/dropbox/working/stan_bayesian_modeling/greg/plots/ind_regressions_id2.pdf')
par(mfrow=c(5,5),mar=c(1,1,1,1),cex.axis=0.7,oma=c(3,3,3,3))
...
pdf('d:/dropbox/working/stan_bayesian_modeling/greg/plots/ind_regressions_id3.pdf')
par(mfrow=c(5,5),mar=c(1,1,1,1),cex.axis=0.7,oma=c(3,3,3,3))
